    ...
    <div className="flex-1 bg-slate-950 text-slate-100 flex flex-col justify-between">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full flex-1">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  {dbUser.role === "ADMIN"
                    ...
                    : dbUser.role === "OWNER"
                    ? "Host mode active: Manage your listings and booking requests"
                    : "Guest mode active: Explore and book premium stays"}
                </p>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/"
            className="hidden sm:flex items-center gap-1.5 text-xs font-bold text-indigo-400 hover:text-indigo-300 transition-colors"
          >
            <span>View all 200+ stays</span>
